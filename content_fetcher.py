            ...
            if isinstance(item, dict):
                ...
                if name and thumbnailurl:
                    ...
                    if 'drm/wv' in thumbnailurl:
                        ...
                        new_url = thumbnailurl.replace('/snapshots', '')
                        new_url = new_url.replace('videos.classplusapp.com/vod-9a3dfb', 'alisg-cdn-a.classplusapp.com')
                        new_url = new_url.rsplit('/', 1)[0] + '/master.m3u8'
                        thumbnailurl = new_url
